...
SECRET_KEY = "django-insecure-x4)-yb3)m68bhz)wqmkm4ye(khnf086qy*7_*lh%ry(l*&3l+("
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",  # Example: your frontend app URL
...
# Optional: Allow specific methods in CORS requests
CORS_ALLOW_METHODS = [
    'DELETE',
    'GET',
    'OPTIONS',
